...
const Footer = () => {
  return (
    <footer className="pt-32 pb-12 bg-background relative overflow-hidden transition-colors duration-500 border-t border-foreground/5">
      <Wrapper>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 lg:gap-24 relative z-10">
          {/* Logo & Copyright */}
        ...
        {/* Big Background Text - Moved outside Wrapper to ignore constraints */}
        <div className="relative mt-10 select-none overflow-hidden w-full h-auto">
